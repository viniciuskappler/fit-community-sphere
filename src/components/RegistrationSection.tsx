...
const RegistrationSection = () => {
  return (
    <section id="registration-section" className="w-full bg-[#f7f7fa] py-12 px-4 flex flex-col items-center">
      <div className="w-3/4 mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
          {options.map((opt) => (
            <div
              key={opt.title}
              className="flex flex-col items-center bg-white rounded-2xl p-6 shadow-sm border border-[#ebebef] max-w-xs w-full transition-shadow hover:shadow-md"
            >
              ...
              <Button
                className="bg-orange-500 hover:bg-orange-700 text-white font-semibold px-6 py-2 rounded-lg text-sm shadow-none transition"
                tabIndex={-1}
                type="button"
              >
                Selecionar
