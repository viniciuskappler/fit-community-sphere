...
const PromoCodeInput = ({ 
  ...
  return (
    <div className="space-y-4">
      {/* Highlighted Header */}
      <div className="text-center p-6 bg-gradient-to-r from-orange-100 to-red-100 rounded-xl border-2 border-orange-300">
        <div className="flex items-center justify-center mb-3">
          <Gift className="text-orange-600 mr-2" size={28} />
      ...
      <div className="flex gap-3">
        <div className="flex-1 relative">
          <Input
            ...
            className={`
              text-base py-3 px-4 font-semibold text-orange-800 placeholder-orange-400
              border-2 border-orange-300 rounded-lg bg-orange-50
        ...
        <Button
          ...
          className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-semibold px-6 py-3 rounded-lg border-0 shadow-lg transition-all duration-200"
        >
          {loading ? (
