      ...
      <section className="py-16 bg-white">
        <div className="w-full md:w-11/12 lg:w-3/4 mx-auto px-4 md:px-8 lg:px-8">
                ...
                <div className="p-4">
                  ...
                  <div className="flex space-x-2">
                    <button 
                      ...
                      className="flex-1 bg-gradient-to-r from-orange-600 to-orange-400 hover:from-orange-700 hover:to-orange-500 text-white py-2 rounded-lg font-semibold text-sm hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-1"
                    >
          ...
          <div className="text-center mt-10">
            <button 
              onClick={showDevelopmentModal}
              className="bg-gradient-to-r from-orange-600 to-orange-400 hover:from-orange-700 hover:to-orange-500 text-white rounded-lg font-semibold text-sm hover:shadow-lg transition-all duration-300 px-[32px] py-[12px] flex items-center space-x-2"
            >
